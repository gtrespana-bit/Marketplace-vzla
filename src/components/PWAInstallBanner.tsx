          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-5 animate-slideUp">
            ...
            <div className="space-y-3 bg-gray-50 rounded-xl p-4">
              <div className="flex items-center gap-3 text-sm">
                ...
                <p dangerouslySetInnerHTML={{ __html: t('iosStep1').replace('<strong>', '<strong>').replace('</strong>', '</strong>') }} />
                <Share size={14} className="inline flex-shrink-0" />
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <p dangerouslySetInnerHTML={{ __html: t('iosStep2') }} />
              </div>
            </div>
            <button
