  ...
  return (
    <div className="floating-chat">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-80 mb-4 overflow-hidden animate-fadeIn">
          ...
          <div className="p-3 border-t">
            <form className="flex gap-2">
              <input type="text" placeholder="Escribe un mensaje..." className="flex-1 border rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-yellow" />
      ...
      <button
        ...
        className="w-14 h-14 bg-brand-blue text-white rounded-full shadow-lg hover:bg-blue-900 transition flex items-center justify-center"
      >
