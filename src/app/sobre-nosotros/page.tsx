...
export const metadata: Metadata = {
  title: 'Sobre Nosotros — TuCambalo',
  description: 'Conoce la historia detrás de TuCambalo, el marketplace hecho para Venezuela',
}

export default function SobreNosotrosPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-black text-gray-800 mb-2 text-center">Sobre TuCambalo</h1>
      ...
      <div className="space-y-10">
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p className="text-gray-600 leading-relaxed mt-4">
            Así nació TuCambalo: un marketplace pensado desde y para Venezuela. Con búsqueda en dólares sin intermediarios complicados. Con WhatsApp, porque aquí todos lo usan. Y con un diseño que funciona bien aunque tu internet no sea el mejor.
          </p>
        </section>
