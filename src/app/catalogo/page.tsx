...
export default function CatalogoPage({
  ...
  const { categoria, estado, ubicacion, q } = searchParams
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <aside className="w-full lg:w-64 flex-shrink-0">
          <div className="bg-white rounded-xl p-5 shadow-sm sticky top-20">
            ...
            <div className="mb-4">
              ...
              <select className="w-full border rounded-lg px-3 py-2 text-sm" id="ubicacion">
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input type="number" placeholder="Min" className="w-full border rounded-lg px-3 py-2 text-sm" />
                <input type="number" placeholder="Max" className="w-full border rounded-lg px-3 py-2 text-sm" />
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <select className="w-full border rounded-lg px-3 py-2 text-sm" id="orden">
        ...
        <div className="flex-1">
          ...
          {/* Grid de productos (datos de ejemplo) */}
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            ...
            <button className="w-10 h-10 rounded-lg font-medium text-sm bg-white text-gray-700 hover:bg-gray-50 transition">
              →
            </button>
          </div>
        </div>
  ...
  return (
    <a
      ...
      className={`bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition group block ${
        destacado ? 'featured-card' : 'border border-gray-100'
      }`}
    >
