    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-sm text-gray-600 space-y-6">
        <section>
          ...
          <p>Bienvenido a VendeT-Venezuela. Al usar nuestra plataforma, aceptas estos términos y condiciones. Si no estás de acuerdo con alguno de estos términos, no utilices nuestros servicios.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">2. Descripción del servicio</h2>
          <p>VendeT-Venezuela es una plataforma de publicación de anuncios que conecta compradores y vendedores. No somos parte de las transacciones: no manejamos pagos ni entregas, y no nos hacemos responsables de los productos publicados.</p>
        </section>
        ...
        <section>
          ...
          <p>VendeT-Venezuela no garantiza la veracidad de los anuncios ni la calidad de las transacciones. Los usuarios actúan bajo su propio riesgo. Recomendamos tomar precauciones durante las transacciones.</p>
        </section>
