...
// ✅ OPTIMIZACIÓN: Dynamic imports para componentes que no son críticos para el LCP
const BotonDescargarApp = dynamic(() => import('@/components/BotonDescargarApp'), { ssr: false })
