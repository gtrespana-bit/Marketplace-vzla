            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {metodos.whatsapp && vendedor?.telefono && (() => {
                  const telefono = formatarWhatsapp(vendedor.telefono)
                  const mensaje = encodeURIComponent(`Hola! Vi tu publicacion "${producto.titulo}" en Todo Anuncios y me interesa. ¿Esta disponible?`)
                  return (
                    <a href={`https://wa.me/${telefono}?text=${mensaje}`} target="_blank" className="bg-[#25D366] text-white py-3 rounded-xl font-bold hover:bg-green-700 transition flex items-center justify-center gap-2 text-sm">
