          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6 sticky top-20">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {metodos.whatsapp && whatsappUrl && (
                  <a href={whatsappUrl} target="_blank" className="bg-[#25D366] text-white py-3 rounded-xl font-bold hover:brightness-90 transition flex items-center justify-center gap-2 text-sm">
