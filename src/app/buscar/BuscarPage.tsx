  ...
  return (
    <Link href={`/producto/${p.id}`} className={`bg-white rounded-xl overflow-hidden hover:shadow-lg transition group block border ${isPromoted ? 'border-2 border-brand-yellow shadow-sm' : 'border-gray-100 shadow-sm'}`}>
      <div className="aspect-square bg-gray-100 relative overflow-hidden">
        ...
        {p.imagen_url ? (
          <Image src={p.imagen_url} alt={p.titulo} width={300} height={300} sizes="(max-width: 768px) 50vw, 25vw" className="w-full h-full object-cover group-hover:scale-105 transition-transform" loading="lazy" decoding="async" />
        ) : (
